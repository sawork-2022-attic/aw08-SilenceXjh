...
public class DeliveryMapper {
    ...
    public DeliveryDto toDeliveryDto(Delivery delivery) {
        return new DeliveryDto().deliveryId(delivery.getId()).order(toOrderDto(delivery.getOrder()));
    }

    public Delivery toDelivery(DeliveryDto deliverydto) {
        return new Delivery(deliverydto.getDeliveryId(), toOrder(deliverydto.getOrder()));
    }
